      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-3xl mb-16">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold text-[#0B3019] mb-6 tracking-tight leading-tight" style={{ fontFamily: 'var(--font-fraunces)' }}>
              Make a <span className="text-[#FFCC00] drop-shadow-sm">Difference</span> Today
            </h1>
            <p className="text-lg md:text-xl text-[#5A5A5A] leading-relaxed">
              Your contribution directly empowers our mission. 100% of your donation goes towards community programs, education, and sustainable development initiatives.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-10 items-start">
          ...
          >
            ...
            {/* Amount Selection */}
            <div className="mb-12">
              <h3 className="text-lg font-bold text-[#0B3019] mb-5">Select Amount</h3>
            ...
            <div className="mb-12">
              <h3 className="text-lg font-bold text-[#0B3019] mb-5">Personal Information</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  <label className="block text-sm font-semibold text-[#5A5A5A] mb-2 ml-1">First Name</label>
                ...
                <div>
                  <label className="block text-sm font-semibold text-[#5A5A5A] mb-2 ml-1">Last Name</label>
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-semibold text-[#5A5A5A] mb-2 ml-1">Email Address</label>
            ...
            <div className="mb-10">
              <h3 className="text-lg font-bold text-[#0B3019] mb-5">Payment Method</h3>
              ...
              <div className="bg-[#FFFDF5] border-2 border-[#FFCC00]/40 rounded-xl p-6 relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <p className="text-[#5A5A5A] text-xs font-semibold mb-0.5">Bank Name</p>
                    <p className="font-bold text-[#0B3019]">Global Heritage Bank</p>
                  </div>
                  <div>
                    <p className="text-[#5A5A5A] text-xs font-semibold mb-0.5">Account Name</p>
                    <p className="font-bold text-[#0B3019]">COCOF NGO</p>
                  </div>
                  <div className="md:col-span-2 mt-1">
                    <p className="text-[#5A5A5A] text-xs font-semibold mb-1.5">Account Number (IBAN)</p>
          ...
          >
            ...
            <div className="bg-[#0B3019] rounded-3xl p-8 md:p-10 text-white relative overflow-hidden shadow-2xl">
              ...
              <h3 className="text-3xl font-bold mb-8 relative z-10" style={{ fontFamily: 'var(--font-fraunces)' }}>Your <span className="text-[#FFCC00]">Impact</span></h3>
              ...
              <ul className="space-y-8 relative z-10">
                <li className="flex gap-5">
                  ...
                  <div>
                    <h4 className="font-bold text-xl mb-1 text-white">Provides Meals</h4>
                    <p className="text-white/70 text-base leading-relaxed">Feeds a family of four for an entire week, ensuring basic nutrition.</p>
                  </div>
                </li>
                <li className="flex gap-5">
                  <div className="flex-shrink-0 w-14 h-14 rounded-2xl bg-[#FFCC00] flex items-center justify-center text-xl font-bold text-[#0B3019] shadow-inner">
                  ...
                  <div>
                    <h4 className="font-bold text-xl mb-1 text-white">Education Kit</h4>
                    <p className="text-white/70 text-base leading-relaxed">Supplies a child with books, uniforms, and stationary for a school term.</p>
                  </div>
                </li>
                <li className="flex gap-5">
                  <div className="flex-shrink-0 w-14 h-14 rounded-2xl bg-[#FFCC00] flex items-center justify-center text-xl font-bold text-[#0B3019] shadow-inner">
                  ...
                  <div>
                    <h4 className="font-bold text-xl mb-1 text-white">Healthcare Access</h4>
                    <p className="text-white/70 text-base leading-relaxed">Covers essential medical checkups and treatments for remote communities.</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-[0_4px_24px_rgba(26,26,26,0.04)] border border-[#0B3019]/5">
              ...
              <p className="text-xl text-[#0B3019] font-medium leading-relaxed italic mb-8">
                "COCOF's transparency is unmatched. I know exactly where my money goes and I receive regular updates on the projects I support."
              </p>
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h4 className="font-bold text-lg text-[#0B3019]">Sarah Mitchell</h4>
